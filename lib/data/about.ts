...
export const aboutFull: AboutFull = {
  ...
  paragraphs: [
    ...
    'Every patient receives personalized attention and a customized treatment plan designed to support their unique healing journey and long-term wellness goals.',
  ],
  image: '/dr-kamilah-professional-portrait.jpeg',
  imageAlt: 'Dr. Kamilah Jordaan professional portrait',
}
